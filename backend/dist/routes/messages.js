...
router.get('/matches', auth_1.authenticate, (0, errorHandler_1.asyncHandler)(async (req, res) => {
...
router.get('/:matchId', auth_1.authenticate, (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const userId = req.user.id;
...
router.get('/:matchId/info', auth_1.authenticate, (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const userId = req.user.id;
    const { matchId } = req.params;
    const match = await prisma.match.findFirst({
        where: {
